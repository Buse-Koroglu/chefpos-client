...
import { BookOpen, Boxes, ChevronLeft, ChevronRight, Layers, MapPin, UtensilsCrossed, Users } from 'lucide-react'
      ...
      <nav className="flex flex-1 flex-col gap-1 px-3 py-3">
        {SIDEBAR_ITEMS.map(({ label, icon: Icon, to }) => (
          <NavLink
            ...
            className={({ isActive }) =>
              cn('flex items-center gap-2.5 border-l-2 px-3 py-2.5 text-base font-medium transition-colors',
