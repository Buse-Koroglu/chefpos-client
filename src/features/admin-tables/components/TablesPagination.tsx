...
export function TablesPagination({ pageNumber, totalPages, totalCount, onPageChange }: TablesPaginationProps) {
  ...
  return (
    <div className="flex items-center justify-between border-t border-zinc-200 bg-white px-4 py-3">
      <p className="text-sm text-zinc-500">Toplam {totalCount} masa</p>
