...
export function DashNavigationCard({ title, description, actionLabel, icon: Icon, onClick }: DashNavigationCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="group flex flex-1 items-center justify-between gap-4 border border-zinc-200 bg-white p-5 text-left transition-colors hover:border-zinc-300 hover:bg-zinc-50"
    >
