...
export const APP_ROUTES: RouteConfiguration[] = [
  ...
  { path: '/app/orders/:id', label: 'Sipariş Detay', allowedRoles: ['CASHIER', 'WAITER'], showInSidebar: false },
  ...
  { path: '/app/kitchen-orders', label: 'Mutfak Siparişleri', allowedRoles: ['KITCHEN'], showInSidebar: true },
